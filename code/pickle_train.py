...
def do_training(data_dir, model_dir, device, image_size, input_size, num_workers, batch_size,
    ...
    train_dataset = PickleDataset("/opt/ml/input/data/split/img/train")
    ...
    if finetune :
        ...
        model.load_state_dict(torch.load('/opt/ml/input/code/trained_models/pretrained_east.pth', map_location='cpu'))    
    # training
    else :   
        model = EAST() 
